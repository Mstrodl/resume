...
\begin{document}
\name{Galen Guyer}
\tagline{Backend Software Engineer Seeking a Summer 2021 Co-op}
\personalinfo{%
  ...
  \linkedin{in/galen-g}\\\smallskip
  \github{MasterChief-John-117}\\\smallskip
...
\item Used of the url fragment for single page navigation so the full page doesn't need to be reloaded on navigation
\end{itemize}
